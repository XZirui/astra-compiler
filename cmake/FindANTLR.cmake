...
if(ANTLR_EXECUTABLE AND Java_JAVA_EXECUTABLE)
    ...
    macro(ANTLR_TARGET Name InputFile)
        ...
        set(ANTLR_ONE_VALUE_ARGS PACKAGE OUTPUT_DIRECTORY OUTPUT_DIRECTORY_PREFIX DEPENDS_ANTLR)
        ...
        if(ANTLR_TARGET_OUTPUT_DIRECTORY)
            ...
            if (ANTLR_TARGET_OUTPUT_DIRECTORY_PREFIX)
                set(ANTLR_${Name}_OUTPUT_DIR
                        ${CMAKE_CURRENT_BINARY_DIR}/antlr4cpp_generated_src/${ANTLR_TARGET_OUTPUT_DIRECTORY_PREFIX})
            else()
                set(ANTLR_${Name}_OUTPUT_DIR
